# Рустамов Арсен Сергійович
# ІВ-93
# 20 у списку групи
# масив с сначала служит для формирование начальноей таблици путем слияния масива а(значениея х1 х2 х3 ) и б(х0 dx) и после нахождения XH1 XH2 XH3 и значний х0 dx они также вносяться в этот масив,масив с - хранить все данние которые нужны для построениея таблички
import numpy as np
